...
func (o *GetJobDetailURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetJobDetailURL")
	}
...
func (o *GetJobDetailURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetJobDetailURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetJobDetailURL")
	}
