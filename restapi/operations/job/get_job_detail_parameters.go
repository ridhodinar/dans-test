...
// NewGetJobDetailParams creates a new GetJobDetailParams object
//
...
// GetJobDetailParams contains all the bound params for the get job detail operation
...
func (o *GetJobDetailParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
